...
The macOS app handles native screenshot capture, annotation, clipboard history,
and the notch-style capture shelf. See `apps/macos/README.md` for permissions,
local development, and architecture notes.
